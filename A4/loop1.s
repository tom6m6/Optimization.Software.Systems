...
main:                                   # @main
.Lfunc_begin0:
	.file	0 "/home/tommy/A4code/homework3" "loop.c" md5 0xfe27a5da90ed2d2b69e01a98f1b09add
...
.Ltmp12:
	#DEBUG_VALUE: main:j <- [DW_OP_constu 1, DW_OP_or, DW_OP_stack_value] $rax
	#DEBUG_VALUE: main:j <- [DW_OP_constu 1, DW_OP_or, DW_OP_stack_value] $rax
	movl	4132(%rsp,%rax,4), %edx
	.loc	0 71 25 is_stmt 0               # loop.c:71:25
	addl	8224(%rsp,%rax,4), %ecx
	addl	8228(%rsp,%rax,4), %edx
.Ltmp13:
	#DEBUG_VALUE: main:j <- [DW_OP_constu 2, DW_OP_or, DW_OP_stack_value] $rax
	#DEBUG_VALUE: main:j <- [DW_OP_constu 2, DW_OP_or, DW_OP_stack_value] $rax
	.loc	0 71 18                         # loop.c:71:18
	movl	%ecx, 32(%rsp,%rax,4)
	.loc	0 71 32                         # loop.c:71:32
	movl	4136(%rsp,%rax,4), %ecx
	.loc	0 71 25                         # loop.c:71:25
	addl	8232(%rsp,%rax,4), %ecx
.Ltmp14:
...
.Ltmp16:
	#DEBUG_VALUE: main:j <- $rax
	.loc	0 70 23 is_stmt 0               # loop.c:70:23
	cmpq	$1024, %rax                     # imm = 0x400
.Ltmp17:
	.loc	0 70 9                          # loop.c:70:9
	jne	.LBB0_2
.Ltmp18:
# %bb.3:                                #   in Loop: Header=BB0_1 Depth=1
	...
	#DEBUG_VALUE: main:j <- $rax
	#DEBUG_VALUE: main:i <- $ebx
	.loc	0 69 25 is_stmt 1               # loop.c:69:25
	addl	$1, %ebx
.Ltmp19:
	#DEBUG_VALUE: main:i <- $ebx
...
.Ltmp34:
	...
	.loc	1 83 36                         # ././fasttime.h:83:36
	mulsd	.LCPI0_0(%rip), %xmm0
	addsd	%xmm1, %xmm0
.Ltmp35:
	#DEBUG_VALUE: main:elapsedf <- $xmm0
	.loc	0 83 5 is_stmt 0                # loop.c:83:5
	leaq	.L.str(%rip), %rdi
...
.Ldebug_info_start0:
	...
	.long	43                              # DW_AT_abstract_origin
	.byte	2                               # DW_AT_low_pc
	.long	.Ltmp26-.Ltmp22                 # DW_AT_high_pc
	.byte	0                               # DW_AT_call_file
...
.Linfo_string2:
	.asciz	"/home/tommy/A4code/homework3"  # string offset=46
.Linfo_string3:
	.asciz	"gettime"                       # string offset=75
.Linfo_string4:
	.asciz	"tv_sec"                        # string offset=83
.Linfo_string5:
	.asciz	"long"                          # string offset=90
.Linfo_string6:
	.asciz	"__time_t"                      # string offset=95
.Linfo_string7:
	.asciz	"tv_nsec"                       # string offset=104
.Linfo_string8:
	.asciz	"__syscall_slong_t"             # string offset=112
.Linfo_string9:
	.asciz	"timespec"                      # string offset=130
.Linfo_string10:
	.asciz	"fasttime_t"                    # string offset=139
.Linfo_string11:
	.asciz	"s"                             # string offset=150
.Linfo_string12:
	.asciz	"tdiff"                         # string offset=152
.Linfo_string13:
	.asciz	"double"                        # string offset=158
.Linfo_string14:
	.asciz	"start"                         # string offset=165
.Linfo_string15:
	.asciz	"end"                           # string offset=171
.Linfo_string16:
	.asciz	"clock_gettime"                 # string offset=175
.Linfo_string17:
	.asciz	"int"                           # string offset=189
.Linfo_string18:
	.asciz	"__clockid_t"                   # string offset=193
.Linfo_string19:
	.asciz	"clockid_t"                     # string offset=205
.Linfo_string20:
	.asciz	"rand_r"                        # string offset=215
.Linfo_string21:
	.asciz	"unsigned int"                  # string offset=222
.Linfo_string22:
	.asciz	"main"                          # string offset=235
.Linfo_string23:
	.asciz	"A"                             # string offset=240
.Linfo_string24:
...
.Linfo_string28:
	.asciz	"C"                             # string offset=284
.Linfo_string29:
	.asciz	"argc"                          # string offset=286
.Linfo_string30:
	.asciz	"argv"                          # string offset=291
.Linfo_string31:
	.asciz	"char"                          # string offset=296
.Linfo_string32:
	.asciz	"total"                         # string offset=301
.Linfo_string33:
	.asciz	"seed"                          # string offset=307
.Linfo_string34:
	.asciz	"j"                             # string offset=312
.Linfo_string35:
	.asciz	"time1"                         # string offset=314
.Linfo_string36:
	.asciz	"i"                             # string offset=320
.Linfo_string37:
	.asciz	"time2"                         # string offset=322
.Linfo_string38:
	.asciz	"elapsedf"                      # string offset=328
	.section	.debug_str_offsets,"",@progbits
	.long	.Linfo_string0
	.long	.Linfo_string1
	.long	.Linfo_string2
